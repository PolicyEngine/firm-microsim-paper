...
\begin{column}{\colwidth}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.90\colwidth]{figures/vat_threshold_revenue_impact.png}
  \end{figure}
  ...
  \begin{block}{Threshold sweep (2025--26)}
    ...
    \begin{figure}
      \centering
      \includegraphics[width=0.62\colwidth]{figures/revenue_impact_2025_26.png}
    \end{figure}
  \end{block}
...
\begin{column}{\colwidth}
  ...
  \begin{alertblock}{The dominated region}
    \leadin{\flow Beyond revenue: measuring the notch's distortion.}
  ...
  \begin{block}{How reforms change it}
    \leadin{Which reforms actually shrink this band?}
    \begin{itemize}
  ...
  \begin{block}{Bunching is mechanical}
    ...
    \begin{figure}
      \centering
      \includegraphics[width=0.94\colwidth]{figures/bunching_analysis_85k.png}
    \end{figure}
  \end{block}
...
\begin{column}{\colwidth}
  ...
  \begin{block}{Reform menu (common \pounds85k / \pounds183.6bn base)}
    ...
    \begin{figure}
      \centering
      \includegraphics[width=0.86\colwidth]{figures/firms_impact_2025_26.png}
    \end{figure}
  \end{block}
