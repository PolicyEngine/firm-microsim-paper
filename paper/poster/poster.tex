...
\institute[PolicyEngine]{PolicyEngine \quad \faGlobe~\texttt{www.policyengine.org}
  \quad\textbar\quad free, open-source policy analysis}
\footercontent{\texttt{github.com/PolicyEngine/firm-microsim-paper}
  \;\textbar\; Open \& reproducible
  \;\textbar\; \texttt{www.policyengine.org}}
...
\begin{column}{\colwidth}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.82\colwidth]{figures/firms_by_turnover_band_85k.png}
  \end{figure}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.72\colwidth]{figures/vat_firms_by_turnover_band_85k.png}
  \end{figure}
...
\begin{column}{\colwidth}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.88\colwidth]{figures/turnover_distribution_85k.png}
  \end{figure}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.88\colwidth]{figures/vat_threshold_revenue_impact.png}
  \end{figure}
  ...
  \begin{block}{Threshold sweep (2025--26)}
    ...
    \begin{figure}
      \centering
      \includegraphics[width=0.64\colwidth]{figures/revenue_impact_2025_26.png}
    \end{figure}
  \end{block}
...
\begin{column}{\colwidth}
  ...
  \begin{block}{Reform menu (common \pounds85k / \pounds183.6bn base)}
    ...
    \begin{figure}
      \centering
      \includegraphics[width=0.64\colwidth]{figures/firms_impact_2025_26.png}
    \end{figure}
  \end{block}
  ...
  \begin{block}{Bunching is mechanical}
    ...
    \begin{figure}
      \centering
      \includegraphics[width=0.70\colwidth]{figures/bunching_analysis_85k.png}
    \end{figure}
  \end{block}
  ...
  \begin{alertblock}{The dominated region}
    ...
    \begin{figure}
      \centering
      \includegraphics[width=0.66\colwidth]{figures/dynamic_notch_fit_e017.png}
    \end{figure}
  \end{alertblock}
