...
The ONS register covers businesses registered for VAT and/or
...
employment membership for a count target, the expected registration propensity
times a sector indicator for HMRC registered-sector counts, and the firm's net
liability $v_i$ for a VAT-liability target. Registration propensity equals one
above the threshold and the HMRC voluntary-registration share below it. I choose
...
2023--24 vintage---the OBR's published near-threshold profile. Chart~C of the
...
the threshold, candidate firms are placed in a seeded random order and selected
until their cumulative calibration weight reaches the HMRC count $M$ of
registered firms in the \pounds1--threshold band. This matches the weighted
total to within one firm's weight but does not identify which firms register
voluntarily; their composition remains a modelling assumption. The resulting
dataset comprises approximately $2.94$~million firm
...
dimension, the vintages attain overall calibration accuracies of 92.9\%
(2023--24) and 93.5\% (2024--25), with calibrated-dimension scores ranging
from 88.3\% to 97.3\%; Appendix~\ref{app:data} reports
...
sample sizes are 92{,}326 (3.1\% of rows) and 188{,}612 (6.4\%), while maximum
weights are about 2{,}598 and 1{,}775. Synthetic rows should therefore be read
...
across it (about $10{,}300$ just above), and declines through the band---the
...
are not like-for-like. The steps at \pounds90{,}000 (about $9{,}100$ firms
per \pounds1{,}000 in the last OBR-pinned bin against about $6{,}800$ in the
first unpinned bin) and \pounds150{,}000 are calibration-target
boundaries---the top of the OBR fine-band window and an HMRC band edge
respectively---not features of the underlying firm distribution. The
