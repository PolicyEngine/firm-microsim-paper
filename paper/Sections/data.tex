...
2019--20 outturn and the OBR's 2025--26 frozen-threshold projection (the
chart's final row, the \pounds90{,}000 bin, lies beyond the fine window and
is not used). All twenty-five bins enter as \emph{shape} targets, applied
side-consistently: each side of the threshold takes the OBR profile's
within-side shape, normalised over its own window
(\pounds65{,}000--\pounds85{,}000 below; \pounds85{,}000--\pounds90{,}000
above) and scaled to the synthetic population's own mass there. The chart
counts HMRC traders---a different unit and, below the threshold, a
substantially narrower universe than the ONS business frame---so its levels
...
dimension, the vintages attain overall calibration accuracies of 89.2\%
(2023--24) and 92.8\% (2024--25), with dimension scores ranging from 77.9\%
(2023--24 employment bands) to 94.2\%; Appendix~\ref{app:data} reports
