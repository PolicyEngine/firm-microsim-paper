...
threshold sweep of Section~\ref{sec:results}---are evaluated on these firms, by
re-applying the registration rule to the microdata for the static costings and by
re-solving firm optimisation for the behavioural exercise
(Section~\ref{sec:counterfactuals}). I hold the empirical turnover distribution
