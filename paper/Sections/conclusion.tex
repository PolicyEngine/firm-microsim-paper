...
Behavioural raise-to-\pounds100k ($e=0.05$--$0.32$) & $e$-sensitivity range & $-\pounds444$m to $-\pounds111$m & \S\ref{sec:behavioural} \\
\bottomrule
\end{tabular}
\end{table}
...
the misallocation distortion. The microdata are synthetic and calibrated to coarse aggregate
