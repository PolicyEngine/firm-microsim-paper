...
\midrule
Static cost, \pounds85k to \pounds90k anchor, 2025--26 & dereg.\ / 43\% retention & $-\pounds234$m / $-\pounds134$m (HMRC $-\pounds185$m) & Section~\ref{sec:static} \\
Static sweep, \pounds90k baseline & \pounds70k to \pounds120k & $+\pounds0.19$bn to $-\pounds1.19$bn & Table~\ref{tab:static_revenue} \\
Dominated region & $a=T^{*}\tau/(1-\tau)$ & \pounds21{,}250 & Section~\ref{ssec:dominated} \\
In-scope firms in the dominated band (weighted) & --- & $\approx$143{,}000 & Section~\ref{ssec:dominated} \\
Raise to \pounds100k, static and behavioural & invariant in $e$ & $-\pounds742$m & Sections~\ref{sec:static}, \ref{sec:behavioural} \\
Taper $[\pounds85\text{k},\pounds141.7\text{k}]$, linear / constant $50\%$, static & --- & $-\pounds1{,}406$m / $-\pounds968$m & Section~\ref{ssec:schedule_costs} \\
Reduced rate $10\%$ / $15\%$ $[\pounds85\text{k},\pounds105\text{k}]$, static & --- & $-\pounds446$m / $-\pounds223$m & Section~\ref{ssec:schedule_costs} \\
Bunching readback, 2023--24 & $E$; $b_{\mathrm{LLAT}}$ (target-inherited) & $5{,}498$; $5.357$ & Section~\ref{sec:bunching} \\
\bottomrule
\end{tabularx}
\end{table}
...
population is the natural next build. A fixed cross-section also has no entry
margin, which is why the anchor's middle years fall short of HMRC's profile.
The nominal-growth factors used for ageing are assumptions recorded in the
replication repository. It also cannot capture persistent
