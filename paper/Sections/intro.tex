...
\pounds85{,}000 to \pounds90{,}000, whose mechanical 2025--26 cost brackets
HMRC's published \pounds185m between the full-deregistration and 43\%
retention conventions---is a consistency check, not a validation, because the
registration behaviour of just-released firms is not identified
(Section~\ref{sec:static}). Second, the shape and rate reforms act on the
