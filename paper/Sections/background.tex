...
below-threshold firms therefore register \emph{voluntarily}---roughly $43\%$ of
eligible below-threshold firms \citep{liuetal2021}, driven by input-VAT reclaim and
...
policy debate, notably \citet{ots2017vat}, which canvassed a financial incentive or
reduced effective rate to smooth the cliff-edge at the threshold. A banded reduced rate introduces a smaller \emph{secondary} notch
