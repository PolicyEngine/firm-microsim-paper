...
is therefore the business-to-consumer upper bound---the width facing a firm
with no reclaimable inputs---and the reform comparisons below, which are
statements about how each schedule changes $a$ at given $\tau$ and $T^{*}$,
carry over to $a(\delta)$ firm by firm with the same ordering.
